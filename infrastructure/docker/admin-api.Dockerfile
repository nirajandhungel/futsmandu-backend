...
#
# Compiled output lands in: apps/api-admin/dist/main.js
...
COPY --from=builder --chown=admin-api:nodejs /app/apps/api-admin ./apps/api-admin
...
CMD ["node", "apps/api-admin/dist/main.js"]
